...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full bg-white/95 backdrop-blur-md shadow-[0_2px_15px_rgba(0,0,0,0.03)] border-b border-neutral-100 select-none font-sans transition-all duration-300">
      ...
      <div className="w-full bg-[#FAF6EE] border-b border-[#F2EAE0]">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-2 w-full flex flex-col sm:flex-row justify-between items-center gap-2 text-[10px] font-medium tracking-wider">
          <div className="uppercase text-neutral-600 text-center sm:text-left">
          ...
          <div className="flex items-center gap-4 text-neutral-500">
            ...
            <div className="flex items-center gap-1.5 hover:opacity-85 transition-opacity">
              ...
              />
              <span>
                GOLD 22KT: <span className="text-primary font-bold">₹7,325.00</span>
              </span>
            </div>
            ...
            <div className="flex items-center gap-1.5 hover:opacity-85 transition-opacity">
              ...
              />
              <span>
                SILVER 999: <span className="text-neutral-700 font-bold">₹95.00</span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6 lg:gap-8">
          ...
          <div className="hidden md:block w-64 lg:w-80 transition-all duration-300">
            <div className="relative w-full group">
              <input
                ...
                className="w-full bg-neutral-50 hover:bg-neutral-100/60 focus:bg-white border border-neutral-200 focus:border-primary/80 rounded-full pl-10 pr-4 py-2 text-xs text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-4 focus:ring-primary/5 transition-all duration-300"
              />
          ...
          <div className="flex items-center gap-5 md:gap-7">
            ...
            <Link href="/account" className="flex flex-col items-center group cursor-pointer text-center">
              ...
              <span className="hidden md:inline text-[9px] font-semibold mt-1.5 tracking-wider uppercase text-neutral-600 group-hover:text-primary transition-colors duration-200">Account</span>
            </Link>
            ...
            <Link href="/wishlist" className="flex flex-col items-center group cursor-pointer text-center">
              ...
              <span className="hidden md:inline text-[9px] font-semibold mt-1.5 tracking-wider uppercase text-neutral-600 group-hover:text-primary transition-colors duration-200">Wishlist</span>
            </Link>
            ...
            <Link href="/cart" className="flex flex-col items-center group cursor-pointer text-center">
              ...
              <span className="hidden md:inline text-[9px] font-semibold mt-1.5 tracking-wider uppercase text-neutral-600 group-hover:text-primary transition-colors duration-200">Cart</span>
            </Link>
          </div>
        </div>
      </div>
      ...
      <nav className="hidden md:block w-full border-t border-neutral-100">
        <div className="max-w-7xl mx-auto px-8">
          <ul className="flex items-center md:justify-center gap-7 py-2.5 overflow-x-auto whitespace-nowrap scrollbar-hide text-[10px] font-semibold tracking-[0.16em] text-neutral-600">
              ...
              <li key={category.name}>
                <Link
                  ...
                  className={`relative py-1.5 transition-colors uppercase hover:text-primary ${category.active
                      ...
                      : "text-neutral-500 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-primary after:rounded-full after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-left"
                    }`}
                >
                  {category.name}
                </Link>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden fixed inset-0 z-50 flex">
          ...
          {/* Drawer content */}
          <div className="relative w-4/5 max-w-sm h-full bg-[#FFFCF5] shadow-2xl flex flex-col p-6 z-50 animate-slide-in border-r border-neutral-100">
